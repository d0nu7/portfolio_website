...
const copy = {
  de: {
    ...
    priceIntro: "Die bestehenden Schulungsmodule machen Standardformate planbar. Branchenwissen, eigene Use Cases und neue Themen werden transparent ergänzt.",
    ...
    packages: [
      { name: "KI-Impuls", price: "1.290 €", description: "Kompakter Einstieg für Teams und Entscheider:innen.", features: ["bis 2 Stunden", "Grundlagen und Einordnung", "Live-Demos und Fragerunde"] },
      { name: "Halbtags-Workshop", price: "1.990 €", description: "Praxisnaher Einstieg mit ersten eigenen Aufgaben.", features: ["bis 4 Stunden", "Prompting und Qualität", "Übungen und Unterlagen"] },
      { name: "Ganztags-Workshop", price: "2.990 €", description: "Die vollständige Basisschulung mit ausreichend Praxis.", features: ["bis 8 Stunden", "Recht, Datenschutz und AI Act", "Übungen und Teilnahmebestätigung"], featured: true },
      { name: "Zwei-Tages-Intensiv", price: "4.990 €", description: "Vertiefung mit Workflows und konkreten Use Cases.", features: ["bis 16 Stunden", "mehr Hands-on-Phasen", "persönlicher Aktionsplan"] },
    ],
    addons: [
      ["Branchenbeispiele · +580 €", "Vier Stunden Anpassung an Fachbereich und Zielgruppe."],
      ["Eigene Use Cases · +1.160 €", "Acht Stunden Vorbereitung mit Aufgaben der Organisation."],
      ["Neues Thema · 145 €/Std.", "Vorab geschätzter und schriftlich gedeckelter Rechercheaufwand."],
    ],
    ...
    faq: [
      ...
      ["Ist die Schulung eine AI-Act-Zertifizierung?", "Nein. Sie unterstützt Maßnahmen zur Entwicklung und Dokumentation von KI-Kompetenz, ersetzt aber weder Rechtsberatung noch die organisationsinterne Risiko- und Maßnahmenplanung."],
  ...
  en: {
    ...
    priceIntro: "Proven modules keep standard formats predictable. Industry context, custom use cases and new topics are added transparently.",
    ...
    packages: [
      { name: "AI impulse", price: "€1,290", description: "A focused introduction for teams and decision-makers.", features: ["up to 2 hours", "foundations and context", "live demos and Q&A"] },
      { name: "Half-day workshop", price: "€1,990", description: "A practical introduction using first real tasks.", features: ["up to 4 hours", "prompting and quality", "exercises and materials"] },
      { name: "Full-day workshop", price: "€2,990", description: "The complete foundation course with sufficient practice.", features: ["up to 8 hours", "law, privacy and the AI Act", "exercises and attendance confirmation"], featured: true },
      { name: "Two-day intensive", price: "€4,990", description: "Deeper practice with workflows and concrete use cases.", features: ["up to 16 hours", "extended hands-on sessions", "personal action plan"] },
    ],
    addons: [
      ["Industry examples · +€580", "Four hours of adaptation to your field and audience."],
      ["Custom use cases · +€1,160", "Eight hours of preparation with tasks from your organisation."],
      ["New topic · €145/hour", "Research effort estimated and capped in writing before work begins."],
    ],
    ...
    faq: [
      ...
      ["Is this an AI Act certification?", "No. It supports measures to develop and document AI literacy, but does not replace legal advice or the organisation’s own risk and measures planning."],
