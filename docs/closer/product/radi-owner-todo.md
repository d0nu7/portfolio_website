...
- [x] Establish the complete transition matrix and characterize setup/entry, consent, act-entry/break, private-moment, Question 37, and question-destination transition families.
