...
The compiled-destination family is implemented in
`src/closer/engine/transitions.js`. All other rows still live in the controller
until their own characterization slice is complete.
