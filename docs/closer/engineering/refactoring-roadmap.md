...
4. [ ] Keep rendering declarative: phase selectors decide which screen is shown; screen components emit events. Setup, both private consent sequences, and intro/act/break presentation are extracted; private moments, finale, and question presentation remain to be split incrementally.
