...
- SLOW BURN consumer V1 deliberately excludes the pilot-only intimate-area card and every prohibited category in the memo. The implemented interaction deliberately departs from the memo's high-friction masked gate proposal after real-device feedback: the app stores ordinary route progress only, while all agreement and adjustment remain direct interpersonal communication.
