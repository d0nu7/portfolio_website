...
/*
 * COUPLES (iteration 8 catalog rollout). Same rationale as
 * date-night-pack.spec.js. COUPLES' Quick/Standard routes also end one
 * question short of the pack's real closer (Q36) -- see the relaxed
 * "ends on last:true" test in closer.test.js -- so the "finishing" test
 * here checks the route-aware copy, not any last:true-specific UI.
 */
test.describe('COUPLES quick route (12 questions, 4 per act)', () => {
